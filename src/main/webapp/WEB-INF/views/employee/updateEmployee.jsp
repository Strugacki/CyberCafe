...
<PUBLIC! html>
	<head>
		...
		<title> Cyber Cafe - edytuj pracownika</title>
	</head>
    		...
    		<c:if test="${!empty edit}" >
				...
				<div class="row">
					<div class="form-group col-lg-12 col-md-12 col-sm-12">
						...
						<c:out value="${userProfil.idUser}"></c:out>
				...
				<div class="row">
					<div class="form-group col-lg-12 col-md-12 col-sm-12">
						...
						<div class="col-lg-3 col-md-3 col-sm-3">
							<form:select id="active" class="form-control input-sm" path="userProfil.active">
								<form:option value="true">Tak</form:option>
								<form:option value="false">Nie</form:option>
							</form:select>
						</div>
						<form:errors path="userProfil.active" cssClass="alert alert-danger col-lg-4 col-md-4 col-sm-4"/>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-lg-12 col-md-12 col-sm-12">
				...
				<div class="row">
					<div class="form-actions col-lg-8 col-md-8 col-sm-8 pull-right">
						...
						href="<c:url value='/customer/list' />">wróć</a>
					</div>
				</div>
			</form>
			</div>
