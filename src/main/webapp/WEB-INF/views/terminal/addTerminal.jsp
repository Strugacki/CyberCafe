...
<PUBLIC! html>
	<head>
		...
		<title> Cyber Cafe - dodawanie sprzętu</title>
	</head>
			...
			<form:form modelAttribute="newTerminal" class="form-horizontal" accept-charset="UTF-8">
				...
				<div class="row">
					<div class="form-group col-lg-12 col-md-12 col-sm-12">
						...
						<div class="col-lg-3 col-md-3 col-sm-3">
							<form:textarea htmlEscape="false" id="description" path="description" class="form-control" required="reguired" cols="20" rows="10"/>
						</div>
