		...
		<div class="col-lg-8 col-lg-push-2 col-md-8 col-md-push-2 col-sm-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-5 col-lg-push-3 col-md-5 col-md-push-3 col-sm-10">
					...
					<br>
			       	<form:form modelAttribute="rentToUpdate" class="form-horizontal" accept-charset="UTF-8">
			       		<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12">
								<label class="control-label col-lg-3 col-md-3 col-sm-3" for="userDetails">Klient: </label>
								<div class="col-lg-8 col-md-8 col-sm-8">
									<div class="form-control col-lg-8 col-md-8 col-sm-8" id="userDetails">
										<c:out value="${rentToUpdate.customer.firstName}" /> "<c:out value="${rentToUpdate.customer.nickname}" />"" <c:out value="${rentToUpdate.customer.lastName}" />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12">
								...
								<div class="col-lg-8 col-md-8 col-sm-8">
									<div class="form-control col-lg-8 col-md-8 col-sm-8" id="terminalType">
										<c:out value="${rentToUpdate.terminal.type}" />
									</div>
								</div>
							</div>
						</div>
			       		<form:input  path="terminal" type="text" required="reguired" class="terminal" value="${rentToUpdate.terminal.idTerminal}" hidden="hidden"/>
			       		<form:input  path="customer" type="text" required="reguired" class="customer" value="${rentToUpdate.customer.idUser}" hidden="hidden"/>
				        <form:input id="type" path="employee" type="text" required="reguired" value="${rentToUpdate.employee.idUser}" hidden="hidden"/>
					   	<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12">
								<label class="control-label col-lg-3 col-md-3 col-sm-3" for="rentDate">Data: </label>
								<div class="col-lg-8 col-md-8 col-sm-8">
									<div class="input-group date" data-provide="datepicker">
					 					<form:input type="text" path="date" class="form-control" id="rentDate" value="${rentToUpdate.date}"/>
					   ...
					   <div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12">
								...
								<div class="results col-lg-8 col-md-8 col-sm-8">
									<form:select class="form-control" id="hoursList" path="timeStart" disabled="true">
					   					<option selected="selected" value="<c:out value="${rentToUpdate.timeStart}" />"><c:out value="${rentToUpdate.timeStart}" />:00</option>
					   				</form:select>
								</div>
							</div>
						</div>
					   <!--<form:input type="text"  path="timeStart" id="timeStart" hidden="hidden"/>!-->
					   	...
					   	<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12">
								...
								<div class="col-lg-8 col-md-8 col-sm-8">
									<form:select class="form-control hours" id="hours" path="hours" disabled="true">
										<option selected="selected" value="<c:out value="${rentToUpdate.hours}" />"><c:out value="${rentToUpdate.hours}" /></option>
									</form:select>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12">
								...
								<div class="col-lg-8 col-md-8 col-sm-8">
									<form:input type="text" path="price" class="form-control" id="price" value="${rentToUpdate.price}"/>
								</div>
							</div>
						</div>
						<div class="row text-center">
