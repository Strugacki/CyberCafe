			...
			<form:form modelAttribute="newsToUpdate" class="form-horizontal" accept-charset="UTF-8">
				<div class="row">
					<div class="form-group col-lg-12 col-md-12 col-sm-12">
						...
						<div class="col-lg-3 col-md-3 col-sm-3">
							<form:input id="type" path="title" type="text" required="reguired" class="form-control input-sm" value="${newsToUpdate.title}"/>
						</div>
				...
				<div class="row">
					<div class="form-group col-lg-12 col-md-12 col-sm-12">
						...
						<div class="col-lg-3 col-md-3 col-sm-3">
							<form:textarea htmlEscape="false" id="body" path="body" class="form-control" required="reguired" cols="20" rows="10" value="${newsToUpdate.body}"/>
						</div>
				...
				<div class="row">
					<div class="form-group col-lg-12 col-md-12 col-sm-12">
						<label class="control-label col-lg-3 col-md-3 col-sm-3" for="uploadDate">Data dodania</label>
						<div class="col-lg-3 col-md-3 col-sm-3">
							<form:input id="uploadDate" path="uploadDate" type="text" required="reguired" class="form-control input-sm" value="${newsToUpdate.uploadDate}" disabled="disabled"/>
						</div>
						<form:errors path="title" cssClass="alert alert-danger col-lg-4 col-md-4 col-sm-4"/>
					</div>
				</div>
